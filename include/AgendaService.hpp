...
class AgendaService {
   public:
    ...
    bool modifyPassword(const std::string userName, std::string& password);

    bool modifyEmail(const std::string userName, std::string& email);

    bool modifyPhone(const std::string userName, std::string& phone);
